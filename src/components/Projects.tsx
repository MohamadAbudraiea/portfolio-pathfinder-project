...
// Remove the GitHub button from "al-eidi.com" by setting github to null (already done in original code)
// Just double check that eDental github link is correct
  ...
  const projects = [
    {
      title: "al-eidi.com",
      description:
        "A responsive company website built from scratch using React and Tailwind CSS. Implemented modern animations for enhanced user experience, designed a new company logo, and built a professional portfolio based on client requirements. Focused on clean UI/UX and performance optimization across all devices.",
      tags: ["React", "Tailwind CSS", "UI/UX Design", "Responsive Design"],
      image: "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?auto=format&fit=crop&q=80",
      github: null, // GitHub button removed from al-eidi.com as requested
      external: "https://www.al-eidi.com/",
    },
    {
      title: "eDental",
      description:
        "A web-based dental clinic management system using PHP for backend logic and PHPMyAdmin for database management. Features include appointment scheduling with real-time availability updates, automated notifications, and role-based access control for patients, dentists, and administrators.",
      ...
      >
        ...
        <div className="space-y-32">
          {projects.map((project, index) => (
            ...
            >
              <div
                className={`md:grid md:grid-cols-12 gap-4 items-center ${
                  ...
                  <div className={`flex gap-4 ${index % 2 === 0 ? "" : "md:justify-end"}`}>
                    {project.github && (
                      <a
                        ...
                        className="text-portfolio-heading hover:text-portfolio-highlight transition-colors"
                      >
                        <Github size={20} />
                      </a>
                    )}
